...
function init_alphabet() {
    ...
    arr_zeichen = [
        ...
        [10, 0, 14, 17, 17, 31, 17, 17, 0], //Ä
        [10, 0, 14, 17, 17, 17, 17, 14, 0], //Ö
        [10, 0, 17, 17, 17, 17, 17, 14, 0], //Ü
        ...
        [0, 12, 12, 0, 12, 12, 0, 0], //a
        [24, 25, 2, 4, 8, 19, 3, 0], //b
        [0, 0, 14, 1, 15, 17, 31, 0],//c
        [16, 16, 22, 25, 17, 17, 14, 0], //b
        [0, 0, 15, 16, 16, 16, 15, 0], //c
        [1, 1, 13, 19, 17, 17, 15, 0], //d
        [0, 0, 14, 17, 31, 16, 14, 0], //g
        [2, 5, 4, 14, 4, 4, 4, 0], //h
        [0, 0, 15, 17, 15, 1, 14, 0], //i
